...
export default function Simulations() {
  ...
  const simulations = [
    ...
    },
    {
      ...
      bg: 'bg-green-50',
      description: 'Your startup is running out of runway. Pitch to a panel of AI-simulated investors and handle their tough questions.',
      completed: false,
    },
    {
      id: 'community-1',
